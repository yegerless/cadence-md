...
class TestRAGConfigConstruction:
    ...
    def test_optional_nodes_defaults_and_validation(self) -> None:
        ...
        assert cfg.enable_input_guardrails is True
